...
> 이 문서는 초기 아이디어·요구를 보존한 기록이다. 랜덤 생성·스마트 매칭·구 대기열 설명이 함께 있어 현재 사양으로 사용하지 않는다. 최신 팀매칭 흐름은 [팀매칭 기획](TEAM_MATCHING_SPEC.md), 기획·구현 차이는 [정합성 검토](TEAM_MATCHING_REVIEW.md)를 참고한다(2026-09-07 정리).
