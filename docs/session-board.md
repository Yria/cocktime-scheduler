...
일반 회원에게는 운영진용 보기 전용 프레임·권한 버튼을 표시하지 않는다. 세션에 참여한 회원은 보드에서 원하는 회원을 끌어 1~4명 묶음을 만들 수 있다. 빈 곳에 놓으면 1명 묶음, 다른 자유 자석 위에 놓으면 2명 묶음, 묶음 위에 놓으면 최대 4명까지 추가한다. 묶음 밖으로 빼거나 더블탭하면 선택이 해제된다. 경기 중이거나 실제 팀에 속한 회원도 제안에 담을 수 있지만 원래 경기·팀 소속은 바뀌지 않는다.
