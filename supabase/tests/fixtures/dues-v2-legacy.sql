-- Minimal legacy schema for isolated PostgreSQL transition tests.
    ...
    create table sessions(id bigint primary key,title text,status text,scheduled_at timestamptz,ends_at timestamptz,place_id bigint,recurring_schedule_id bigint,court_fee int);
